...
export default function Page() {
  ...
  return <main>
    ...
    <section className="shell contact-section" id="contact"><div><span className="eyebrow">GET IN TOUCH</span><h2>Have a repetitive workflow<br /><em>worth automating?</em></h2><p>If your team spends significant time manually reviewing documents, moving information between systems, preparing reports, or organizing incoming requests, I&apos;d be interested in understanding the workflow.</p></div><div className="contact-actions"><a className="button primary" href={`mailto:${email}`}>Email me <ArrowUpRight size={16} /></a><a className="button secondary" href={socialLinks.linkedin} target="_blank" rel="noreferrer"><Network size={16} /> LinkedIn</a><a className="button ghost" href={socialLinks.github} target="_blank" rel="noreferrer"><GitBranch size={16} /> GitHub</a></div></section>
